...
/*
 * Check the login details provided in the config are valid and set
...
/*
 * Send a message to the Android C2DM server.
 */
C2DM.prototype.send = function(packet, cb) {
  var self = this;
  // Handle token updates if they come along
  this.once('token', this.captureToken);
